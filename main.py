...
BACKGROUND_COLOR = (255, 255, 255) # White background for padding fallback (BGR format)
...
def crop_to_content(image):
    ...
    # If the square falls outside image boundaries, use padding canvas
    if x_min < 0 or y_min < 0 or x_max > w_img or y_max > h_img:
        ...
        # Paste the image content onto the canvas
        canvas[dst_y_min:dst_y_max, dst_x_min:dst_x_max] = image[src_y_min:src_y_max, src_x_min:src_x_max]
        return canvas
    else:
